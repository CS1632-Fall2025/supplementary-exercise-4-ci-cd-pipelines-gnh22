...
public class RentACatUnitTest {
	...
	public void testGetCatNumCats3() throws Exception {
		// TODO: Fill in
		// c1 = Cat.createInstance(InstanceType.MOCK, 1, "Jennyanydots");
		// c2 = Cat.createInstance(InstanceType.MOCK, 2, "Jennyanydots");
	...
	/**
	 * Test case for boolean rentCat(int id).java.lang.AssertionError
	  at org.junit.Assert.fail(Assert.java:87)
	  at org.junit.Assert.assertTrue(Assert.java:42)
	  at org.junit.Assert.assertNotNull(Assert.java:713)
	  at org.junit.Assert.assertNotNull(Assert.java:723)
	  at edu.pitt.cs.RentACatUnitTest.testGetCatNumCats3(RentACatUnitTest.java:137)
